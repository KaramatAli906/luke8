({
    ...
    */
    ...
    /**
    * Renders the view showing both enabled and disabled users
    */
    _render: function () {
        var self = this;
        var data = [];
    ...
    /**
    * Responsible for changing divs as a user is switched between gsync enabled and active users
    */
    ...
    */
    ...
    /**
    * Makes an API call to fetch active and gsync enabled users
    */
    ...
    /**
    * Handles response from API call to fetch users for GSync
    */
    ...
    /**
    * Returns true if passed value is a number
    *
    ...
    */
    ...
    /**
    * After performing certain checks, makes an API call to save users for GSync
    */
    handleSave: function () {
        app.alert.dismiss('rtGSync_config');
    ...
    /**
    * If API call to save GSync users fail, displays the error message with reason
    */
    ...
    /**
    * Notifies when Users for GSync are updated successfully
    */
    ...
    /**
    * Fetch already saved user configuration and display when the userConfiguration page is refreshed
    */
    refreshPAGE: function () {
        this.getUserConfig();
    },
    /**
    * Called on Enable All button, it enables all users for RTGSync
    */
