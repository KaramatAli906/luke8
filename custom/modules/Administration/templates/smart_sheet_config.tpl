                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" id="sheet_main_div" class="yui3-skin-sam edit view panelContainer">
                    ...
                    <span>
                        <td valign="top" id="data_source_name" width="12.5%" scope="col">
                            ...
                            <span><h3 style="color: #000000"> <span style="margin-right: 35px;"> Module:</span> {html_options id=module_dropdown name=module_dropdown options=$module_options selected=$module_options_selected }
                            </h3>
                                    <p></p></span>
                        </td>
                    </span>
