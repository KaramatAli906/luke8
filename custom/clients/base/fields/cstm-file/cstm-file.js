...
({
    ...
    initialize: function (options) {
        var viewArray = ['record', 'create'];
        if (_.isEqual(_.indexOf(viewArray, options.view.name), -1)) {
        }
    ...
    _createFileObj: function (value, urlOpts) {
        ...
        this.newTabLink = '#bwc/index.php?entryPoint=openpdf&id=' + this.model.get('id') + '&module=' + this.module
