...
class SmartSheetApiHelper {
    ...
    public function __construct() {;
        ...
        $this->access_token=self::retrieveSettings($admin->settings['smartsheet_api_key']);
    ...
    public static function retrieveSettings($settings) {
        ...
        if (!empty($result)) {
            ...
            return self::array_to_object($settings);
        } else {
            return $settings;
        }
