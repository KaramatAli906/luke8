...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
  ...
  'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_ADMIN_USER' => 'If certain fields are not editable, please login to your Cloud Console to manage these fields',
  ...
  'LBL_EDITVIEW_PANEL1' => 'RT GSync',
  'LBL_PERSONALIZED_MESSAGE' => 'Personalized Message',
  'LBL_GMAIL_ID' => 'Gmail ID',
  'LBL_GOOGLE_ACCOUNT' => 'Google Account Information',
  'LBL_GOOGLE_AUTH' => 'Authenticate from Google',
  'ERR_GMAIL_ID' => 'Please save Gmail email id in your profile before authenticating.',
);