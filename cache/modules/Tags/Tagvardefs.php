<?php 
 $GLOBALS["dictionary"]["Tag"]=array (
  ...
  array (
    ...
    'jckl_filterdeployments_link' => 
    array (
      'name' => 'jckl_filterdeployments_link',
      'vname' => 'jckl_FilterDeployments',
      'type' => 'link',
      'relationship' => 'jckl_filterdeployments_tags',
      'source' => 'non-db',
    ),
    'jckl_filterselections_link' => 
    array (
      'name' => 'jckl_filterselections_link',
      'vname' => 'jckl_FilterSelections',
      'type' => 'link',
      'relationship' => 'jckl_filterselections_tags',
      'source' => 'non-db',
    ),
    'jckl_filtertemplates_link' => 
    array (
      'name' => 'jckl_filtertemplates_link',
      'vname' => 'jckl_FilterTemplates',
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_tags',
      'source' => 'non-db',
    ),
    'dri_workflows_link' => 
    array (
    ...
    'rt_docusign_link' => 
    array (
      'name' => 'rt_docusign_link',
      'vname' => 'RT_DocuSign',
      'type' => 'link',
      'relationship' => 'rt_docusign_tags',
      'source' => 'non-db',
    ),
    'dp_doucumentspackets_link' => 
    array (
      'name' => 'dp_doucumentspackets_link',
      'vname' => 'DP_DoucumentsPackets',
      'type' => 'link',
      'relationship' => 'dp_doucumentspackets_tags',
      'source' => 'non-db',
    ),
    'mvh_colorselection_link' => 
    array (
      'name' => 'mvh_colorselection_link',
