...
3. After saving, use the subpanels available on the target\'s record view to add {{campaigns_singular_module}} recipients.',
  ...
  'LBL_SUBSCRIBER_HASH' => 'MailChimp subscriber hash',
  'LBL_CRM_TO_MC_SYNC_DATE' => 'CRM to MailChimp sync date',
  'LBL_MC_TO_CRM_SYNC_DATE' => 'MailChimp to CRM sync date',
  'LBL_LAST_SYNC_DATE' => 'Sync date',
);