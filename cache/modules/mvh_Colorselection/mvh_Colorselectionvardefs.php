<?php 
 $GLOBALS["dictionary"]["mvh_Colorselection"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mvh_colorselection_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mvh_colorselection_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'vname' => 'LBL_TAGS_LINK',
      'relationship' => 'mvh_colorselection_tags',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'relationship' => 'mvh_colorselection_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mvh_colorselection_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mvh_colorselection_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_mvh_colorselection_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_mvh_colorselection_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_mvh_colorselection_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_mvh_colorselection_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_mvh_colorselection_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_mvh_colorselection' => 
    array (
      'name' => 'idx_mvh_colorselection_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_mvh_colorselection' => 
    array (
      'name' => 'idx_mvh_colorselection_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_mvh_colorselection_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
