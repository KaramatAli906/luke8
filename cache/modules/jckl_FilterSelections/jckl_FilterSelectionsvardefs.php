<?php 
 $GLOBALS["dictionary"]["jckl_FilterSelections"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filterselections_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filterselections_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'jckl_filterselections_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'jckl_filterselections_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'jckl_filterselections_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'jckl_filterselections_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filterselections_assigned_user',
    ...
    'jckl_filtertemplates_jckl_filterselections_name' => 
    array (
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_jckl_filterselections_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_jckl_filterselections_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_jckl_filterselections_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_jckl_filterselections_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_jckl_filterselections_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_jckl_filterselections_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
