<?php 
 $GLOBALS["dictionary"]["jckl_FilterTemplates"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_assigned_user',
    ...
    array (
      ...
      'bean_name' => 'jckl_FilterSelections',
    ...
    array (
      ...
      'bean_name' => 'jckl_FilterDeployments',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_jckl_filtertemplates_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_jckl_filtertemplates_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_jckl_filtertemplates_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_jckl_filtertemplates_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_jckl_filtertemplates_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_jckl_filtertemplates_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
