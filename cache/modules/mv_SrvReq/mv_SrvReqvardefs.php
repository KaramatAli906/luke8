<?php 
 $GLOBALS["dictionary"]["mv_SrvReq"]=array (
  'table' => 'mv_srvreq',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'calculated' => 'true',
      'formula' => 'concat(related($cases_mv_srvreq_1,"name")," - ",$category)',
      'enforced' => true,
    ),
    'date_entered' => 
    array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mv_srvreq_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mv_srvreq_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'mv_srvreq_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'mv_srvreq_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'mv_srvreq_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mv_srvreq_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mv_srvreq_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_mv_srvreq_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_mv_srvreq_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'acl_team_set_mv_srvreq' => 
    array (
      'name' => 'idx_mv_srvreq_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_mv_srvreq_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
