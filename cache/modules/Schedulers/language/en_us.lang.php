...
',
  ...
  'LBL_NO_PHP_CLI' => 'If your host does not have the PHP binary available, you can use wget or curl to launch your Jobs.<br>for wget: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;wget --quiet --non-verbose http://localhost/Luke_data/luke8/cron.php > /dev/null 2>&1</b><br>for curl: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;curl --silent http://localhost/Luke_data/luke8/cron.php > /dev/null 2>&1',
  ...
  'LBL_SUGAR_TO_SMARTSHEET_SYNC' => 'Sugar To Smartsheet Sync',
  'LBL_VERIFY_WEBHOOKS' => 'Smartsheet Webhook Verification',
  'LBL_SMARTSHEET_TO_SUGAR_SYNC' => 'Smartsheeet To Sugar Sync',
  'LBL_MAILCHIMP_SYNC' => 'Mailchimp Sync',
  'LBL_OPS_BACKUPS_FETCH_EXPORTS' => 'Retrieve updated backup listing from SugarCRM',
  'LBL_SMARTSHEET_VENDOR_SYNC' => 'Smartsheet Vendor Sync',
  ...
  'LBL_CUSTOM_EMAIL_REMINDERS' => 'Custom Email Reminders',
);