 ...
 $GLOBALS["dictionary"]["rt_GSync"]=array (
  ...
  array (
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'rt_gsync_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'rt_gsync_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'rt_gsync_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'rt_gsync_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_rt_gsync_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_rt_gsync_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'acl_team_set_rt_gsync' => 
    array (
      'name' => 'idx_rt_gsync_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_rt_gsync_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
