 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'function' => 
      array (
        'include' => 'custom/modules/Contacts/CustomerJourney/EnumManager.php',
        'name' => 
        array (
          0 => '\\Contacts\\CustomerJourney\\EnumManager',
          1 => 'listEnumValues',
        ),
      ),
    ),
    ...
    array (
      'labelValue' => 'Subcontractor Email Group',
      'dependency' => '',
      'visibility_grid' => '',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'subcontractor_email_group_c',
      'vname' => 'LBL_SUBCONTRACTOR_EMAIL_GROUP_C',
      'type' => 'multienum',
      'massupdate' => true,
      'no_default' => false,
      'comments' => '',
      ...
      'default' => NULL,
      'isMultiSelect' => true,
      'id' => 'Contactssubcontractor_email_group_c',
