<?php 
 $GLOBALS["dictionary"]["pmse_BpmProcessDefinition"]=array (
  ...
  array (
    ...
    'm_cams_locked_fields_link' => 
    array (
      'name' => 'm_cams_locked_fields_link',
      'vname' => 'm_CAMS',
      'type' => 'link',
      'relationship' => 'm_cams_locked_fields',
      'source' => 'non-db',
    ),
    'jckl_filtertemplates_locked_fields_link' => 
    array (
      'name' => 'jckl_filtertemplates_locked_fields_link',
      'vname' => 'jckl_FilterTemplates',
      'type' => 'link',
      'relationship' => 'jckl_filtertemplates_locked_fields',
      'source' => 'non-db',
    ),
    ...
    'mv_attachments_locked_fields_link' => 
    array (
      'name' => 'mv_attachments_locked_fields_link',
      'vname' => 'mv_Attachments',
      'type' => 'link',
      'relationship' => 'mv_attachments_locked_fields',
      'source' => 'non-db',
    ),
    'mv_srvreq_locked_fields_link' => 
    array (
      'name' => 'mv_srvreq_locked_fields_link',
      'vname' => 'mv_SrvReq',
      'type' => 'link',
      'relationship' => 'mv_srvreq_locked_fields',
      'source' => 'non-db',
    ),
    'dp_doucumentspackets_locked_fields_link' => 
    array (
      'name' => 'dp_doucumentspackets_locked_fields_link',
      'vname' => 'DP_DoucumentsPackets',
      'type' => 'link',
      'relationship' => 'dp_doucumentspackets_locked_fields',
      'source' => 'non-db',
    ),
    'mvh_colorselection_locked_fields_link' => 
    array (
      'name' => 'mvh_colorselection_locked_fields_link',
      'vname' => 'mvh_Colorselection',
      'type' => 'link',
      'relationship' => 'mvh_colorselection_locked_fields',
      'source' => 'non-db',
    ),
    'rt_gsync_locked_fields_link' => 
    array (
      'name' => 'rt_gsync_locked_fields_link',
      'vname' => 'rt_GSync',
      'type' => 'link',
      'relationship' => 'rt_gsync_locked_fields',
      'source' => 'non-db',
    ),
    'following' => 
    array (
