...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_JCKL_FILTER_LICENSEADDON' => 'Filter Deployer License',
  'LBL_JCKL_FILTER_LICENSEADDON_LICENSE_TITLE' => 'Filter Deployer License Configuration',
  'LBL_JCKL_FILTER_LICENSEADDON_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_JACKAL_DASHBOARD_MANAGER_GROUP_TITLE' => 'Jackal Software Plugins',
  'LBL_JACKAL_DASHBOARD_MANAGER_GROUP_DESCRIPTION' => 'Configure Jackal Software Plugins',
  'LBL_JACKAL_FILTER_TITLE' => 'Filter Deployer for SugarCRM7',
  'LBL_JACKAL_FILTER_DESCRIPTION' => 'Deploy filters to  users',
  'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_TITLE' => 'Customer Journey',
  'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_DESC' => 'Configure the Customer Journey Plugin',
  ...
  'LBL_SMARTSHEET_HEADER' => 'Smartsheet',
  'LBL_SMARTSHEET_DESCRIPTION' => 'Configure the Smartsheet plugin ',
  'LBL_SMARTSHEET_TITLE' => 'Configure sync fields',
  'LBL_SYN_SUGAR_TOSMARTSHEET' => 'Validate Keys',
  'LBL_SYN_SUGAR_TOSMARTSHEET_DESCRIPTION' => 'Validate smartsheet API Keys and save it.',
  'LBL_MAILCHIMP_CONFIGURATION_PANEL' => 'MailChimp Configurations',
  'LBL_MAILCHIMP_CONFIGURATION_PANEL_LINK' => 'MailChimp Configurations',
  'LBL_MAILCHIMP_CONFIGURATION_INFO' => 'Configurations wizard for changing your API Key',
  'LBL_MAILCHIMP_FIELDS_MAPPING_PANEL_LINK' => 'Field Mapping',
  'LBL_MAILCHIMP_FIELDS_MAPPING_INFO' => 'Check on the current state of your MailChimp synchronization',
  'LBL_MAILCHIMP_MODULES_MAPPING_PANEL_LINK' => 'Module Mapping',
  'LBL_MAILCHIMP_MODULES_MAPPING_INFO' => 'Set Target Lists to sync  with Leads/Contacts and Set Admin User for incoming Subscribers',
  'LBL_AN_ERROR_OCCURRED_DETAILS' => 'An error occurred, Details: ',
  'LBL_MAILCHIMP_CONFIGURATION' => 'MailChimp Configuration',
  'LBL_CONNECTED_WITH_MAILCHIMP' => 'Connected with MailChimp.',
  'LBL_NOT_CONNECTED_WITH_MAILCHIMP' => 'Not Connected with MailChimp.',
  'LBL_API_KEY' => 'API Key:',
  'LBL_TEST_CONNECTION' => 'Test Connection',
  'LBL_TEST_CONNECTION_SUCCESS' => 'Hurrah! Everything\'s Chimpy!',
  'LBL_TEST_CONNECTION_ERROR' => 'API key was invalid.',
  'LBL_MAILCHIMP_SAVE_API_KEY_SUCCESS' => 'MailChimp API Key saved successfully.',
  'LBL_MAILCHIMP_SAVE_API_KEY_ERROR' => 'You can not save an invalid API key, Please update again.',
  'LBL_MAILCHIMP_FIELDS_MAPPING' => 'MailChimp Fields Mapping',
  'LBL_SELECT_A_MAILCHIMP_LIST' => 'Select a MailChimp list: ',
  'LBL_SELECT_MODULE' => 'Select Module: ',
  'LBL_MAILCHIMP_FIELDS' => 'MailChimp Fields',
  'LBL_CONTACTS' => 'Contacts',
  'LBL_LEADS' => 'Leads',
  'LBL_TARGETS' => 'Targets',
  'LBL_SUCCESS_FIELDS_SAVING' => 'Fields mapping saved successfully.',
  'LBL_ERROR_FIELDS_SAVING' => 'An error occurred, while saving fields mapping.',
  'LBL_ERROR_FIELDS_GETTING' => 'An error occurred, while getting fields mapping.',
  'LBL_FIELDS_EMAIL_ADDRESS' => 'Email Address (EMAIL)',
  'LBL_FIELDS_EMAIL_ADDRESS_LOWER' => 'Email Address (email1)',
  'LBL_MAILCHIMP_MODULES_MAPPING' => 'MailChimp Modules Mapping',
  'LBL_ADMIN_USER_MAPPING' => 'Admin User Mapping',
  'LBL_SELECT_ADMIN_USER' => 'Select Admin User (This will be assign to and created by for the subscribers coming from MailChimp): ',
  'LBL_LEADS_MAPPING' => 'Leads Mapping',
  'LBL_SELECT_LEADS_MAPPING' => 'Select Target List for Leads: ',
  'LBL_CONTACTS_MAPPING' => 'Contacts Mapping',
  'LBL_SELECT_ACCOUNT_TYPE' => 'Select Account Type: ',
  'LBL_SELECT_TARGET_LIST_FOR_CONTACTS' => 'Select Target List for Contacts: ',
  'LBL_SUCCESS_MODULE_SAVING' => 'Modules mapping saved successfully.',
  'LBL_ERROR_MODULE_SAVING' => 'An error occurred, while saving modules mapping.',
  'LBL_OPS_NOTIFICATION_SETTINGS_LINK_NAME' => 'Notification Settings',
  'LBL_OPS_NOTIFICATION_SETTINGS_LINK_DESCRIPTION' => 'Email Addresses that should be notified for system upgrades and Sugar On-Demand changes.',
  'LBL_OPS_ONDEMAND_SECTION_HEADER' => 'Sugar On-Demand',
  'LBL_OPS_ONDEMAND_SECTION_DESCRIPTION' => 'Sugar On-Demand Modules and Settings',
  ...
  'LBL_OPS_BACKUPS_DESCRIPTION' => 'Download Archived backups of the Sugar On-Demand instance.',
  'LBL_LINK_NAME_EXCELSHEET' => 'Name Mapping',
  'LBL_LINK_DESCRIPTION_EXCELSHEET' => 'Name mapping and upload screen',
  'LBL_SECTION_HEADER_EXCELSHEET' => 'Excelsheet Correction',
  'LBL_EXCEL_FIELDS' => 'Excelsheet Fields',
  'LBL_BUILDINGS' => 'Builders',
  'LBL_EXELSHEET_FIELDS_MAPPING' => 'Excelsheet Fields Mapping',
  'LBL_SECTION_DESCRIPTION_EXCELSHEET' => 'Configuration Builders Excelsheet',
  'LBL_LINK_NAME' => 'Configure RT DocuSign',
  'LBL_LINK_DESCRIPTION' => 'Manage RT DocuSign Configurations.',
  'LBL_SECTION_HEADER' => 'RT DocuSign Configurations',
  'LBL_SECTION_DESCRIPTION' => 'Configurations for RT DocuSign',
  'LBL_MAPPING_LINK' => 'Field Mapping',
  'LBL_MAPPING_DESCRIPTION' => 'DocusSign Fields Mapping for templates',
  'LBL_DOCUSIGN_FIELDS_MAPPING' => 'DocuSign Fields Mapping',
  'LBL_SELECT_A_TEMPLATE' => 'Select a Template: ',
  'LBL_TEMPLATE_FIELDS' => 'Template Fields',
  'LBL_ACCOUNTS' => 'Accounts',
  'LBL_GOOGLECALENDERSYNC' => 'RT GSync- Calendar',
  'LBL_GOOGLECONTACTSSYNC' => 'RT GSync- Contacts',
  'LBL_GOOGLEDRIVESYNC' => 'RT GSync- Drive',
  'LBL_IMPORTCACHEEMAILS' => 'RT GSync- Archive Emails',
  'LBL_GOOGLECALENDERRECURRINGSYNC' => 'RT GSync- Calendar [recurrence]',
