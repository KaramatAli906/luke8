...
$FUNCTION_MAP = array(
            ...
            'isCurrentUser' => array(
                        'class'    =>    'IsCurrentUserExpression',
                        'src'    =>    'custom/include/Expressions/Expression/Boolean/IsCurrentUserExpression.php',
            ),
            'daysBetween' => array(
                        'class'    =>    'DaysBetweenExpression',
                        'src'    =>    'custom/include/Expressions/Expression/Numeric/DaysBetweenExpression.php',
            ),
            'projectDate' => array(
                        'class'    =>    'ProjectDateExpression',
                        'src'    =>    'custom/include/Expressions/Expression/Generic/ProjectDateExpression.php',
            ),
);
