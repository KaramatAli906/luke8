...
/**
 * Construct a new IsCurrentUserExpression.
 */
SUGAR.expressions.IsCurrentUserExpression = function(params, context) {
    this.context = context;
    this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.IsCurrentUserExpression, SUGAR.expressions.BooleanExpression, {
    className: "IsCurrentUserExpression",
    evaluate: function() {
            var params = this.getParameters();
...
/**
 * Construct a new DaysBetweenExpression.
 */
SUGAR.expressions.DaysBetweenExpression = function(params, context) {
    this.context = context;
    this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.DaysBetweenExpression, SUGAR.expressions.NumericExpression, {
    className: "DaysBetweenExpression",
    evaluate: function() {
            var params = this.getParameters();
...
/**
 * Construct a new ProjectDateExpression.
 */
SUGAR.expressions.ProjectDateExpression = function(params, context) {
    this.context = context;
    this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.ProjectDateExpression, SUGAR.expressions.GenericExpression, {
    className: "ProjectDateExpression",
    evaluate: function() {
