...
if(!dce_mode){SQ.parentPanel.center();}},init:function(o){var app=parent.SUGAR.App;var view=app.controller.layout.getComponent('bwc');if(view){view.openComposeEmailDrawer(o.composePackage||{});}
return false;},loadResources:function(o)
